...
class AppTheme {
  ...
  static ColorScheme get lightColorScheme => const ColorScheme(
    ...
    // D1 kontrast bulgusu: beyaz üzerine lightSuccess yalnızca 3.30:1
    // (WCAG AA eşiği 4.5:1'in altında) — koyu metin 5.12:1 ile geçiyor.
    onSecondary: AppColors.lightTextPrimary,
    secondaryContainer: Color(0xFFC8F0D6),
    onSecondaryContainer: Color(0xFF0F3F26),
    tertiary: AppColors.lightWarning,
    // Aynı bulgu: beyaz üzerine lightWarning (amber) yalnızca 2.01:1.
  ...
  static ColorScheme get darkColorScheme => const ColorScheme(
    ...
    // Kartların (AppCard -> surfaceContainerLowest) saf siyah zeminden
    // (AppColors.darkBackground) hafifçe ayrışması için — bkz. C3 notu.
